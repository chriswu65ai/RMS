...
const PROVIDER_TIMEOUT_GENERATE_IDLE_MINUTES_DEFAULT = 5;
...
const PROVIDER_TIMEOUT_TOOL_FIRST_TURN_MS_DEFAULT = 300_000;
const PROVIDER_TIMEOUT_TOOL_FOLLOWUP_MS_DEFAULT = 300_000;
